        ...
        <div className="bg-white overflow-x-hidden">
            ...
            <section className="relative bg-white pb-16 sm:pb-24">
                ...
                <div className="bg-primary pt-16 sm:pt-24 pb-32 sm:pb-48 px-4 md:px-8 lg:px-16 text-center">
                    <span className="text-black font-bold uppercase tracking-[4px] mb-4 block text-xs sm:text-sm">HOW WE WORK</span>
                    ...
                    <div className="flex flex-col lg:flex-row gap-16 items-center">
                        ...
                        <div className="lg:w-1/3">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <span className="text-primary font-bold uppercase tracking-[4px] text-xs sm:text-sm">WORKING PROJECTS</span>
                            </div>
            ...
            <section className="py-16 sm:py-24 md:py-32 bg-gray-50 px-4 text-black md:px-8 lg:px-16">
                <div className="container">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <div>
                            <span className="text-primary font-bold uppercase tracking-[4px] mb-4 block text-xs sm:text-sm">ABOUT US</span>
                ...
                <div className="container relative z-10 mx-auto">
                    <div className="flex flex-col lg:flex-row gap-16 items-start">
                        ...
                        <div className="lg:w-1/3">
                            <div className="flex items-center gap-4 mb-6">
                                <div className="w-12 h-[2px] bg-primary"></div>
                                <span className="text-primary font-bold uppercase tracking-[4px] text-xs sm:text-sm">TESTIMONIALS</span>
                            </div>
            ...
            <section className="py-16 sm:py-24 md:py-32 bg-white px-4 md:px-8 lg:px-16">
                <div className="container max-w-4xl mx-auto">
                    <div className="text-center mb-12 md:mb-20">
                        <span className="text-primary font-bold uppercase tracking-[4px] mb-4 block text-xs sm:text-sm">FREQUENTLY ASKED</span>
