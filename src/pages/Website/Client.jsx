        ...
        <div className="bg-white overflow-x-hidden">
            ...
            <section className="relative bg-[#252f48] py-20 h-[400px] pt-45 border-b border-black/10 overflow-hidden -mx-[calc((100vw-98.5%)/2)] w-screen flex items-center">
                ...
                <div className="container text-center relative z-10">
                    <span className="text-[#0681d4] font-bold uppercase tracking-[6px] mb-4 block">TESTIMONIALS</span>
                    <h1 className="text-5xl md:text-7xl font-black text-white uppercase tracking-tighter">WHAT OUR <span className="text-[#fa5900]">CLIENTS SAY</span></h1>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
                        {loading ? (
                            ...
                            testimonials.map((t, i) => (
                                <div key={i} className="bg-white p-6 sm:p-8 border-2 border-black/10 hover:border-[#fa5900] transition-all shadow-lg">
                                    <div className="text-[#fa5900] text-4xl mb-4">"</div>
                                    <div className="flex text-[#fa5900] gap-1 mb-4">
                                    ...
                                    <div className="border-t border-black/10 pt-4">
                                        ...
                                        <span className="text-[#fa5900] text-[10px] uppercase tracking-widest font-bold">{t.role}</span>
                                    </div>
                                </div>
                            ))
                        ) : (
            ...
            <section className="py-16 sm:py-24 md:py-32 bg-black text-white px-4 md:px-8 lg:px-16">
                <div className="container text-center">
                    <span className="text-[#fa5900] font-bold uppercase tracking-[4px] mb-4 block text-xs sm:text-sm">OUR PARTNERS</span>
                    <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-12 md:mb-16">TRUSTED BY <span className="text-[#fa5900]">INDUSTRY LEADERS</span></h2>
