...
const PrivacyPolicy = () => {
    return (
        <div className="bg-white text-black min-h-screen pt-28 md:pt-32 pb-20">
            {/* Header */}
            ...
            <div className="max-w-4xl mx-auto px-4 md:px-8 lg:px-16">
                <div className="space-y-12">
                    <section className="border-l-4 border-[#fa5900] pl-6">
                        <h2 className="text-2xl font-bold mb-4 text-black">1. Introduction</h2>
                        <p className="text-gray-700 leading-relaxed">
                            AAYANSH 360 SERVICES ("we", "us", "our", or "Company") operates the website. This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data.
                        </p>
                    </section>
                    ...
                    <section className="border-l-4 border-[#fa5900] pl-6">
                        ...
                        <ul className="space-y-2 text-gray-700">
                            <li className="flex items-start gap-3">
                                <span className="text-[#fa5900] font-bold mt-1">•</span>
                    ...
                    <section className="border-l-4 border-[#fa5900] pl-6">
                        ...
                        <p className="text-gray-700 leading-relaxed mb-4">
                            AAYANSH 360 SERVICES uses the collected data for various purposes:
                        </p>
                        <ul className="space-y-2 text-gray-700">
                            <li className="flex items-start gap-3">
                                <span className="text-[#fa5900] font-bold mt-1">•</span>
                    ...
                    <section className="bg-gray-50 border-l-4 border-[#fa5900] pl-6 p-6 rounded">
                        <h2 className="text-2xl font-bold mb-4 text-black">6. Contact Us</h2>
                        <p className="text-gray-700 leading-relaxed mb-4">
                            If you have any questions about this Privacy Policy, please contact us:
                        </p>
                        <div className="space-y-2 text-gray-700">
                            <p><strong>Email:</strong> <a href="mailto:Kishan.rai30@gmail.com" className="text-[#fa5900] hover:underline">Kishan.rai30@gmail.com</a></p>
                            <p><strong>Phone:</strong> <a href="tel:+919999452314" className="text-[#fa5900] hover:underline">+91 9999452314</a></p>
                        </div>
                    </section>
                </div>

                <div className="mt-16 text-center">
                    <Link to="/" className="inline-flex items-center gap-2 bg-[#fa5900] hover:bg-[#e05000] text-white font-bold py-3 px-8 rounded transition-all">
